...
INSERT OVERWRITE TABLE wmf_product.global_markets_pageviews
...
SELECT
  ...
  year, month, day
FROM by_date_country
JOIN canonical_data.countries AS countries
  ON by_date_country.country_code = countries.iso_code
